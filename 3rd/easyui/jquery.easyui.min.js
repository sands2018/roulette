...
opts=$.extend({},$.messager.defaults,{content:"<div>"+opts.msg+"</div>"+"<br/>"+"<div style=\"clear:both;\"/>"+"<div><input class=\"messager-input\" type=\"text\"/></div>"},opts);
if(!opts.buttons){
opts.buttons=[{text:opts.ok,onClick:function(){
...
$.messager.defaults=$.extend({},$.fn.dialog.defaults,{ok:"确定",cancel:"取消",width:600,height:"auto",top:"230",minHeight:150,modal:true,collapsible:false,minimizable:false,maximizable:false,resizable:false,fn:function(){
}});
})(jQuery);
(function($){
