...
if (_2cf == null) // cancel
    dlg.dialog("close");
if ($.trim(_2cf).length == 0)
    return;
if (opts.fn(_2cf)) // return true
    dlg.dialog("close");
};
...
opts=$.extend({},$.messager.defaults,{content:"<div>"+opts.msg+"</div>"+"<div style=\"clear:both; margin-top: 30px;\"/>"+"<div><input class=\"messager-input\" maxlength=\"20\" type=\"text\"/></div>"},opts);
if(!opts.buttons){
opts.buttons=[{text:opts.ok,onClick:function(){
...
$.messager.defaults=$.extend({},$.fn.dialog.defaults,{ok:"OK",cancel:"Cancel",width:60,height:"auto",minHeight:150,modal:true,collapsible:false,minimizable:false,maximizable:false,resizable:false,fn:function(){
}});
})(jQuery);
(function($){
...
$.fn.checkbox.defaults={width:50,height:50,value:null,disabled:false,checked:false,label:null,labelWidth:"auto",labelPosition:"after",labelAlign:"left",onChange:function(_531){
}};
})(jQuery);
(function($){
function init(_532){
